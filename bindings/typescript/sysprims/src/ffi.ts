...
export function callJsonReturn(fn: (outPtr: KoffiOutArray) => number, lib: SysprimsLib): unknown {
...
export function callU32Out(fn: (outPtr: KoffiOutArray) => number, lib: SysprimsLib): number {
  lib.sysprims_clear_error();
