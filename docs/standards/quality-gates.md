...
This workflow is separate from binding workflows because it tests the _published release assets_, not the source code. Binding workflows validate "does the code work?" while this validates "can users download and use the release?"
